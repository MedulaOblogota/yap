...
typedef enum {SORTED_STOP, SORTED_CONTINUE} sorted_status_t;
...
typedef sorted_status_t (*sorted_cmd_func_t)(sorted_list_iter_t iter, void *arg);
typedef int (*is_before_func_t)(const void *data1, const void *data2, const void *param);
...
*******************************************************************************/
sorted_status_t SortedListForEach(sorted_list_iter_t from, sorted_list_iter_t to,
...
sorted_list_iter_t SortedListFind(sorted_list_t *sorted_list, sorted_list_iter_t from,
    sorted_list_iter_t to, void *arg);
...
sorted_list_iter_t SortedListFindIf(sorted_list_iter_t from,
                sorted_list_iter_t to, is_before_func_t is_before, void *arg);
...
*******************************************************************************/
sorted_list_iter_t SortedListGetNext(sorted_list_iter_t iter);
...
*******************************************************************************/
sorted_list_iter_t SortedListGetPrev(sorted_list_iter_t iter);
